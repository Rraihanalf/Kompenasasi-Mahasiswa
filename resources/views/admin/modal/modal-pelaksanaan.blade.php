<!-- <form action="/penugasan" method="post" enctype="multipart/form-data">
    <div class="modal fade text-left" id="Pelaksanaan" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"> Pelaksanaan </h4>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            @enderror
            <select name="pengawas" class="custom-select rounded-0 mb-2  @error('pengawas') is-invalid @enderror" id="exampleSelectRounded0">
                <option value="">Pilih Pengawas</option>
                @foreach ($data as $data)
                <option value="{{ $data->nik }}">{{ $data->nama_pengawas }}</option>
                @endforeach
            </select>
            @error('pengawas')
              <div class="invalid-feedback">
