                                        ...
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $data->ruangan }}</td>
                                                    <td>{{ $data->kegiatan }}</td>
                                                    <td>{{ $data->validasi_pengawas }}</td>
                                                    <td>
                                                        @if($data->validasi_admin === 'Belum Tuntas')
                                                        <form action="/validasi/admin/{{ $data->id_pelaksanaan }}" method="post">
                                                            @csrf
                                                            @method('PUT')
                                                            <input type="text" class="form-control" name="validasi_admin" value="Tuntas" hidden>
                                                        ...
                                                        <button class="btn btn-block btn-inline-success" aria-placeholder="Validasi" disabled>
                                                            <i class="nav-icon fas fa-check"> {{ $data->validasi_admin }}</i>
                                                        </button>
                                                        @endif
                                                    </td>
                                                </tr>
